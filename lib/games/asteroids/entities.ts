/**
 * Port of references/started-games/02-asteroids/game.js.
 *
 * Literal translation: same numbers, same strokes, same formulas. The only
 * structural changes are the ones React forces — draw() takes the context as a
 * parameter instead of reading a module global, and Ship.update() takes the key
