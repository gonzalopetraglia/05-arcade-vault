...
import { Silhouettes } from "@/components/home/silhouettes";
import { formatScore, GAMES } from "@/lib/games";
import {
  HOME_FAQ,
  HOME_FEATURES,
  HOME_STATS,
...
export default function Home() {
  return (
    <div className="home fade-in">
      ...
      <RevealSection className="home-section">
        ...
        <div className="mini-rail">
          {GAMES.slice(0, 6).map((g) => (
            <Link key={g.id} className="mini-card" href={`/games/${g.id}`}>
      ...
      {/* STATS */}
      <RevealSection className="home-stats">
      ...
      {/* FINAL CTA */}
      <RevealSection className="home-final">
